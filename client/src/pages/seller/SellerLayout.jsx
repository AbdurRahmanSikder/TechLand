...
const SellerLayout = () => {
    ...
    return (
        <>
            <div className="flex items-center justify-between px-4 md:px-8 border-b border-white py-3 bg-primary ">
                <Link to="/">
                    <img src={assets.logo} alt='logo' className='cursor-pointer w-32 md:w-48' />
                </Link>
